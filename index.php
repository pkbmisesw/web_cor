...
<main>
            ...
            <div class="row align-items-center">
                <div class="col-xxl-7 col-xl-7 col-lg-6 col-md-12 col-12">
                    <div class="tp-about-class p-relative pb-50">
                        <img src="web_assets/img/about/about-3-bg-01.png" alt="about-img">
                ...
                <div class="col-xl-6">
                    <div class="tp-suit mb-30 p-relative">
                        ...
                        <div class="tp-suit__img">
                            <img src="web_assets/img/bg/suit-bg-01.png" alt="suitable-img">
                        </div>
                    </div>
                </div>
                <div class="col-xl-6">
                    <div class="tp-suit mb-30 p-relative">
                        ...
                        <div class="tp-suit__tech">
                            <img src="web_assets/img/bg/suit-bg-02.png" alt="suitable-img">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="video-bg p-relative text-center">
                        <img src="web_assets/img/bg/video-bg-2.jpg" alt="video-bg">
                        <div class="video-text video-run-time">
                            <i>Live<span>01:30:08</span></i>
                        </div>
                        <div class="video-shape-area">
                            <img class="video-shape" src="web_assets/img/about/shape-2-img-2.png" alt="video-shape">
                            <img class="video-shape-2 d-none d-md-block" src="web_assets/img/about/video-2-shape-2.png" alt="video-shape">
                            <img class="video-shape-3 d-none d-md-block" src="web_assets/img/about/video-2-shape-1.jpg" alt="video-shape">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- catrgory-area -->
    <section class="tp-category-area bg-bottom grey-bg pt-110 pb-80 wow fadeInUp" data-wow-duration=".8s" data-wow-delay=".3s" data-background="web_assets/img/bg/shape-bg-1.png">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title mb-70">
            ...
            <div class="row">
                <div class="col-xxl-3 col-lg-4 col-md-6">
                    <div class="tp-cat-item mb-40 d-flex align-items-center">
                        ...
                        <span class="cat-design">
                           <img src="web_assets/img/category/category2-1.png" alt="category-img">
                        </span>
                        </div>
                ...
                <div class="col-xxl-3 col-lg-4 col-md-6">
                    <div class="tp-cat-item mb-40 d-flex align-items-center">
                        ...
                        <span class="cat-deve">
                           <img src="web_assets/img/category/category2-2.png" alt="category-img">
                        </span>
                        </div>
                        <div class="tp-cat-content">
                ...
                <div class="col-xxl-3 col-lg-4 col-md-6">
                    <div class="tp-cat-item mb-40 d-flex align-items-center">
                        ...
                        <span class="cat-market">
                           <img src="web_assets/img/category/category2-3.png" alt="category-img">
                        </span>
                        </div>
                        <div class="tp-cat-content">
                ...
                <div class="col-xxl-3 col-lg-4 col-md-6">
                    <div class="tp-cat-item mb-40 d-flex align-items-center">
                        <div class="tp-category-icon tp-cat-color mr-15">
                        <span class="cat-it">
                           <img src="web_assets/img/category/category2-4.png" alt="category-img">
                        </span>
                        </div>
                        <div class="tp-cat-content">
                ...
                <div class="col-xxl-3 col-lg-4 col-md-6">
                    <div class="tp-cat-item mb-40 d-flex align-items-center">
                        ...
                        <span class="cat-video">
                           <img src="web_assets/img/category/category2-5.png" alt="category-img">
                        </span>
                        </div>
                        <div class="tp-cat-content">
                ...
                <div class="col-xxl-3 col-lg-4 col-md-6">
                    <div class="tp-cat-item mb-40 d-flex align-items-center">
                        ...
                        <span class="cat-business">
                           <img src="web_assets/img/category/category2-6.png" alt="category-img">
                        </span>
                        </div>
                        <div class="tp-cat-content">
                ...
                <div class="col-xxl-3 col-lg-4 col-md-6">
                    <div class="tp-cat-item mb-40 d-flex align-items-center">
                        ...
                        <span class="cat-photo">
                           <img src="web_assets/img/category/category2-7.png" alt="category-img">
                        </span>
                        </div>
                        <div class="tp-cat-content">
                ...
                <div class="col-xxl-3 col-lg-4 col-md-6">
                    <div class="tp-cat-item mb-40 d-flex align-items-center">
                        ...
                        <span class="cat-music">
                           <img src="web_assets/img/category/category2-8.png" alt="category-img">
                        </span>
                        </div>
                        <div class="tp-cat-content">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-7 col-lg-6 col-md-12">
                    <div class="tp-choose-img tp-big-bg mb-50">
                        <img src="web_assets/img/bg/choose-3-bg-01.png" alt="choose-img">
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- testimonial-area -->
    <section class="testimonial-area bg-bottom pt-115 pb-90  wow fadeInUp" data-wow-duration=".8s" data-wow-delay=".3s" data-background="web_assets/img/bg/shape-bg-1.png">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title text-center mb-65">
            ...
            <div class="testimonial-active-box tp-slide-space-white">
                <div class="tp-test-s-item">
                    <div class="tp-testi tp-testi-round p-relative">
                        <div class="tp-testi__ava testi-ava-border d-flex align-items-center mb-20 pb-20">
                            <img src="web_assets/img/icon/test-avata--1.png" alt="testi-avatar">
                ...
                <div class="tp-test-s-item">
                    <div class="tp-testi p-relative">
                        <div class="tp-testi__ava testi-ava-border d-flex align-items-center mb-20 pb-20">
                            <img src="web_assets/img/icon/testi-avata3-01.png" alt="testi-avatar">
                            <div class="tp-testi__avainfo ml-20">
                ...
                <div class="tp-test-s-item">
                    <div class="tp-testi p-relative">
                        <div class="tp-testi__ava testi-ava-border d-flex align-items-center mb-20 pb-20">
                            <img src="web_assets/img/icon/test-avata--2.png" alt="testi-avatar">
                            <div class="tp-testi__avainfo ml-20">
                ...
                <div class="col-xl-12">
                    <div class="brand-area tp-brand-active">
                        <div class="brand-item">
                            <a href="#"><img src="web_assets/img/icon/brand-icon-01.png" alt="brand-logo"></a>
                        </div>
                        <div class="brand-item">
                            <a href="#"><img src="web_assets/img/icon/brand-icon-02.png" alt="brand-logo"></a>
                        </div>
                        <div class="brand-item">
                            <a href="#"><img src="web_assets/img/icon/brand-icon-03.png" alt="brand-logo"></a>
                        </div>
                        <div class="brand-item">
                            <a href="#"><img src="web_assets/img/icon/brand-icon-04.png" alt="brand-logo"></a>
                        </div>
                        <div class="brand-item">
                            <a href="#"><img src="web_assets/img/icon/brand-icon-05.png" alt="brand-logo"></a>
                        </div>
                        <div class="brand-item">
                            <a href="#"><img src="web_assets/img/icon/brand-icon-01.png" alt="brand-logo"></a>
                        </div>
            ...
            <div class="row">
                    ...
                    <div class="tp-blog tp-blog-parent mb-60">
                        <div class="tp-blog__thumb">
                            <div class="fix blog-round">
                                <a href="blog-details.html"><img src="web_assets/img/blog/blog-thumb-3-01.jpg" alt="blog-img"></a>
                            </div>
                        </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="tp-blog tp-blog-parent mb-60">
                        <div class="tp-blog__thumb">
                            <div class="fix blog-round">
                                <a href="blog-details.html"><img src="web_assets/img/blog/blog-thumb-3-02.jpg" alt="blog-img"></a>
                            </div>
                        </div>
                        <div class="tp-blog__content blog-edu p-relative">
                            <div class="tp-blog__meta-list mb-10">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="tp-blog tp-blog-parent mb-60">
                        <div class="tp-blog__thumb">
                            <div class="fix blog-round">
                                <a href="blog-details.html"><img src="web_assets/img/blog/blog-thumb-3-03.jpg" alt="blog-img"></a>
                            </div>
                        </div>
                        <div class="tp-blog__content blog-edu p-relative">
                            <div class="tp-blog__meta-list mb-10">
